	...
	$('#addBtn').click(function(){
		$('#user-table').append(
			'<tr id="f'+(fileIndex)+'">'
				...
				+'<td width=80%><input type=file name=files['+(fileIndex)+'] size=25></td>'
			+'</tr>'
			/* name:files <== DataBoardVO에서 private List<MultipartFile> files; 만들어놨었음 */
		);
		fileIndex++;
	});
	// 파일 취소 
...
<body>
   <div class="container">
     <h1>글쓰기</h1>
     <div class="row">
      <!-- ★★★ action="insert_ok.do" <=== .jsp가 아니라 .do임!! ★★★-->
